...
##### chunkSize (optional)
The amount of events to read in each call to KurrentDB, defaults to *1000*,
...
Writes an array of KurrentDB ready events to a stream.
...
Sends scavenge command to KurrentDB.
...
Sends shutdown command to KurrentDB.
