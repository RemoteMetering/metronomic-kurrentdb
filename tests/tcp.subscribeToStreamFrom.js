  ...
  it(
    ...
    (done) => {
      ...
      client
        ...
        .then(() =>
          client.subscribeToStreamFrom(testStream, 0, onEventAppeared, undefined, onDropped).then((sub) =>
            sleep(3000).then(() => {
    ...
    (done) => {
      ...
      client
        ...
        .then(() => {
          ...
          return client
            .subscribeToStreamFrom(`$ce-TestStream`, 5, onEventAppeared, undefined, onDropped, settings)
            .then((sub) =>
              sleep(3000).then(() => {
                hasReachAssert = true;
