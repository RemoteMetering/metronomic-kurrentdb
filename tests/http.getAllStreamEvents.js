...
describe('Http Client - Get All Stream Events', () => {
  it(
    'Should write events and read back all stream events',
    async () => {
  ...
  it(
    'Should write events and read back all events from start event',
    async () => {
      const client = new KurrentDB.HTTPClient(getHttpConfig());
  ...
  it(
    'Should write events and read back stream events with embed type rich',
    async () => {
      const client = new KurrentDB.HTTPClient(getHttpConfig());
