...
const debug = debugModule('metronomic-kurrentdb:subscribeToStreamFrom');
const baseErr = 'Subscribe to Stream From - ';

export default (config, checkStreamExists) => (streamName, fromEventNumber, onEventAppeared, onDropped, settings) => {
  settings = settings || {};
